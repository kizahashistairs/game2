...
public class enemyof4direction : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        col =GetComponent<BoxCollider2D>();
          if (anim == null || fire1 == null || fire2 == null || fire3 == null || fire4 == null)
          {
              Debug.Log("設定が足りません");
    ...
    public void attack(){
        ...
        GameObject g4=Instantiate(fire4);
        g4.transform.SetParent(transform);
        g4.transform.position=fire4.transform.position;
        g4.SetActive(true);
        //Debug.Log("attack");
    }
